...
type ServiceArticlesProps = {
  data: ServiceArticlesData;
};

export default function ServiceArticles({
  data,
}: ServiceArticlesProps) {
  return (
    <section className="overflow-hidden bg-[#f5f2ec] py-14 lg:py-20">
            ...
            >
              ...
              >
                ...
                <div className="mt-2 flex items-start justify-between gap-3">
                  ...
                  <h3 className="line-clamp-2 text-right text-sm font-medium leading-6 text-[#171512]">
                    {post.title}
                  </h3>
                </div>
              </Link>
