  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto grid w-full max-w-6xl items-center gap-10 px-6 lg:grid-cols-2 lg:gap-16 lg:px-12">
        ...
        >
          <div className="relative aspect-[4/5] overflow-hidden rounded-sm shadow-[0_16px_36px_-16px_rgba(20,18,15,0.3)]">
            <motion.img
          ...
          <div className="pointer-events-none absolute -bottom-3 -right-3 -z-10 h-full w-full rounded-sm border border-[var(--primary)]/25" />

          {/* Decorative Number */}
          <div className="absolute -bottom-4 -right-3 text-[64px] font-light leading-none text-black/5 sm:text-[80px]">
            15
          </div>
        </motion.div>
